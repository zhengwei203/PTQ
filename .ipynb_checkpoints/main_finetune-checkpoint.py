...
import spikformer_ms
import models
import models_sew
import models_Q
import models_change
...
#     print('==========================')
    ...
    elif args.model_mode == "Q_trick":
        model = models_Q.__dict__[args.model]()
    elif args.model_mode == "1bit":
        model = models_Q_w_1.__dict__[args.model]()
    elif args.model_mode == "new_design":
        model = models_change.__dict__[args.model]()
    elif args.model_mode == "scs":
        model = spikformer_ms.__dict__[args.model]()
